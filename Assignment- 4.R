# Define Seasons and Players
Seasons <- c("2005","2006","2007","2008","2009","2010","2011","2012","2013","2014")
Players <- c("KobeBryant","JoeJohnson","LeBronJames","CarmeloAnthony","DwightHoward","ChrisBosh","ChrisPaul","KevinDurant","DerrickRose","DwayneWade")


# Define free throws made for each player in each season
...
# Combine free throws made into a matrix
...
# Define free throw attempts for each player in each season
...
# Combine free throw attempts into a matrix
...
# Define total points for each player in each season
...
# Combine total points into a matrix
...
# Calculate the free throw accuracy for each player in each season
...
# Calculate the free throw attempts per game for each player in each season
...
# Calculate the points scored per game without considering free throws for each player in each season
print("Points_Without_Free_Throws")
points_without_free_throws<-(Points-free_throws)/field_goals
points_without_free_throws


# Calculate 2-Pointers per Game
